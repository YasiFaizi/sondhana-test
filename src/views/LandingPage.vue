<template>
  <v-container fluid style="background-color: black; height: auto; padding: 0px; margin: 0px; box-sizing: border-box; overflow-x: hidden">
    <v-row v-if="mainPage">
      <v-col style="margin-top:120px;">
        <div class="context">
          ...
          <center>
            <p class="mb-12">
             เพื่อดูรายงาน Influencer ของคุณโดยไม่เสียค่าใช้จ่าย
          ...
          <div style="text-align: center" >
           ...
           <center>
            <p class="mb-12 mt-6" style="color: red">
             โปรดเข้าสู่ระบบด้วยบัญชีที่ใช้งาน Youtube
            </p>
          </center>
...
export default {
  ...
  methods: {
    ...
    routeContentCreate(){
      this.$router.push({name:"ContentCreator"})
    }
  },
